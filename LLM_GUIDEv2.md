...
- Server-side RBAC/session tables, migration history, role/scoping administration, and initial record-scope enforcement now exist. Field masking, import engine, form designer, production backup process, and comprehensive automated tests do not.
